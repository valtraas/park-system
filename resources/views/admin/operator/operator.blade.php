...
<div class="container mt-28  pb-16 md:pl-[280px] px-[30px] md:px-0" id="content">
    <a href={{ route('management.create') }} class="border border-active w-[20%] p-3 rounded-xl hover:bg-active hover:text-white duration-300" >
                ...
                <tr>
                    ...
                    <td class="px-5 py-3 border"> 
                        <div class="flex gap-2 items-center">
                            <div>
                                <a href="{{ route('management.edit',['management'=>$item->username]) }}" class="border border-yellow-500 p-1 rounded-md text-yellow-500 hover:bg-yellow-500 hover:text-white duration-200 ">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                            </div>
                            <div>
                                <form action="{{ route('management.destroy',['management'=>$item->username]) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button class="border border-red-600 p-1 rounded-md text-red-600 hover:bg-red-600 hover:text-white duration-200 ">
